...
import (
	...
	entity "github.com/matiaspub/todo-api/pkg/entity"
...
func (m *MockTodoList) Create(userId int, todoList entity.TodoList) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTodoListMockRecorder) Create(userId, todoList any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockTodoList) GetOne(userId, listId int) (entity.TodoList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOne", userId, listId)
	ret0, _ := ret[0].(entity.TodoList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTodoListMockRecorder) GetOne(userId, listId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOne", reflect.TypeOf((*MockTodoList)(nil).GetOne), userId, listId)
}
...
func (mr *MockTodoListMockRecorder) Update(userId, listId, list any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockTodoItem) Create(userId, listId int, item entity.TodoItem) (int, error) {
	m.ctrl.T.Helper()
...
// GetOne mocks base method.
func (m *MockTodoItem) GetOne(userId, itemId int) (entity.TodoItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOne", userId, itemId)
	ret0, _ := ret[0].(entity.TodoItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetOne indicates an expected call of GetOne.
func (mr *MockTodoItemMockRecorder) GetOne(userId, itemId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOne", reflect.TypeOf((*MockTodoItem)(nil).GetOne), userId, itemId)
}

// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, input entity.UpdateTodoItemInput) error {
	m.ctrl.T.Helper()
